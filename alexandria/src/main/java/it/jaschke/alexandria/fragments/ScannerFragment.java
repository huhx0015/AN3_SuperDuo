 ...
 */
public class ScannerFragment extends Fragment implements ScanditSDKOnScanListener {
    ...
    // LOGGING VARIABLES
    private static final String LOG_TAG = ScannerFragment.class.getSimpleName();
    ...
    public void onAttach(Activity activity) {
        ...
        SCANDIT_SDK_KEY = currentActivity.getResources().getString(R.string.scandit_sdk_key);
    }
