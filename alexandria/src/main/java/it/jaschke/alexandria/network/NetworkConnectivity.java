package it.jaschke.alexandria.network;
 ...
 *  DESCRIPTION: NetworkConnectivity is a class that contains methods for determining if the device has
...
public class NetworkConnectivity {
    ...
    // LOGGING VARIABLES
    private static final String LOG_TAG = NetworkConnectivity.class.getSimpleName();
    ...
    public static Boolean checkConnectivity(Context context) {
        ...
        if (info != null) {
            ...
            try {
                ...
                InetAddress ipAddr = InetAddress.getByName("www.googleapis.com");
